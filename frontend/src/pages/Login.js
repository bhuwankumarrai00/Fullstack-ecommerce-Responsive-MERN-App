  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        toast.error('Wrong Password'); // Display error message for wrong password
      }
    } catch (error) {
    ...
    <div className="mt-3">
      <div className="w-full bg-white p-4 max-w-md mx-auto shadow-md rounded-md">
        ...
        <form className="grid gap-4 py-4" onSubmit={handleSubmit}>
          ...
          <button className="w-full p-2 bg-green-600 text-white font-semibold rounded hover:bg-green-700">
            Login
          </button>
        </form>
